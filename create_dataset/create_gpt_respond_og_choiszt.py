...
from prompt.prompt_utils_og_choiszt import *
    ...
    for act in tqdm(os.listdir("bddl/bddl/activity_definitions")):
        ...
        while True:
            ...
            try:
                ...
                with open(f"/home/jingkang001_e_ntu_edu_sg/liushuai/SG_VLM/data/Omnigibson_sg_planning/{behavior_activity}.txt","w")as f:
