...
def main(random_selection=False, headless=False, short_exec=False):
    ...
    for act in tqdm(os.listdir(data_path)):
        ...
        input_scenegraph ="Scene Graph:\n"+str(initial_scene_graph)+"\nNow,please output your caption as detailed as possible"
        ...
        with open(f"data/OGSG_data/initsg_planning_long_caption/initsg_planning_long_caption_train.json","w")as f:
            f.write(json.dumps(OGSG_result))
