...
def main(
    ...
    input: str = "",
    adapter_path: Path = Path("out/adapter/OGSG/octopus_adapter_04_28_1714308058_initsg_planning_caption/lit-llama-adapter-finetuned.pth"),
    test_EXP: str="initsg_planning_caption",
