deepspeed --master_port 29501 llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path ./data/LLaMA-VID-Finetune/llava_158k_detailv3_reinstall_gpt4v24k_wild15k_mixdocvqa_fixdca30k_fixsynden40k_sg40kt2k_ori_with_video_chatgpt_maxtime_5min.json \
